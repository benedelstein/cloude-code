  ...
  return (
    <div className="relative h-48 w-64 md:h-56 md:w-72">
      ...
      <Image
        ...
        width={88}
        height={88}
        className="absolute bottom-4 left-4 h-20 w-20 object-contain md:h-24 md:w-24"
      />
      <Image
        src="/gemini_logo.svg"
        alt="Gemini"
        width={88}
        height={88}
        className="absolute bottom-8 right-2 h-20 w-20 object-contain md:h-24 md:w-24"
      />
    </div>
  );
}
