...
- Prefer to create separate components when a page or component is getting too long or nested. You can keep the components locally in the same file if they are local to that page, or make a separate component in the components/ directory if they are reusable.
