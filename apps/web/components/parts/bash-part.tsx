  ...
  return (
    <>
      {action.output !== undefined && action.output.length > 0 && (
        <pre className="max-h-72 overflow-auto rounded-md border border-border bg-background px-3 py-2 font-mono text-xs text-foreground-secondary whitespace-pre-wrap wrap-break-word">
          {action.output}
        </pre>
      )}
    </>
