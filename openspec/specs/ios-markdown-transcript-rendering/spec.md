# ios-markdown-transcript-rendering Specification

## Purpose
Structured markdown transcript rendering lets the iOS agent session display streamed assistant markdown as rich prose and dedicated copyable code blocks while preserving raw transcript text for copy and details.
