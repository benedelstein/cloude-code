...
import { GitHubWebhookHandlers } from "./github-webhook-handlers";
export type {
  CreatePullRequestInput,
  GitHubAppErrorCode,
  GitHubAppResult,
...
export class GitHubAppService {
  ...
  private readonly webhookHandlers: GitHubWebhookHandlers;
  ...
  constructor(env: Env, logger: Logger) {
    ...
    this.webhookHandlers = new GitHubWebhookHandlers({
      app: this.app,
      env: this.env,
      logger,
    });
  ...
  async handleWebhook(params: {
    ...
    await this.webhookHandlers.handleWebhook(params);
  }
}
