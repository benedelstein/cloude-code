...
- **@repo/teams-bot** (`apps/teams-bot/`) - Cloudflare Worker that adapts Microsoft Teams Outgoing Webhook mentions into integration session requests against the API server. See `docs/api-server/teams-bot.md`.
